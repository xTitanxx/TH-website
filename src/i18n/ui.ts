...
export const ui: Record<Locale, UIStrings> = {
  en: {
    nav: { house: 'The House', casa: 'Casa Indigo', studio: 'Studio Indigo', shop: 'The Shop', aljezur: 'Aljezur', location: 'Location', contact: 'Enquire' },
    tagline: 'A townhouse in Aljezur.',
    sections: { house: 'The House', casa: 'Casa Indigo', studio: 'Studio Indigo', shop: 'The Shop', aljezur: 'Aljezur & surroundings', location: 'Location', contact: 'Enquire' },
  ...
  pt: {
    nav: { house: 'A Casa', casa: 'Casa Indigo', studio: 'Studio Indigo', shop: 'A Loja', aljezur: 'Aljezur', location: 'Localização', contact: 'Reservar' },
    tagline: 'Uma casa em Aljezur.',
    sections: { house: 'A Casa', casa: 'Casa Indigo', studio: 'Studio Indigo', shop: 'A Loja', aljezur: 'Aljezur e arredores', location: 'Localização', contact: 'Reservar' },
  ...
  fr: {
    nav: { house: 'La Maison', casa: 'Casa Indigo', studio: 'Studio Indigo', shop: 'La Boutique', aljezur: 'Aljezur', location: 'Situation', contact: 'Réserver' },
    tagline: 'Une maison de village à Aljezur.',
    sections: { house: 'La Maison', casa: 'Casa Indigo', studio: 'Studio Indigo', shop: 'La Boutique', aljezur: 'Aljezur et ses environs', location: 'Situation', contact: 'Réserver' },
  ...
  de: {
    nav: { house: 'Das Haus', casa: 'Casa Indigo', studio: 'Studio Indigo', shop: 'Der Laden', aljezur: 'Aljezur', location: 'Lage', contact: 'Anfragen' },
    tagline: 'Ein Stadthaus in Aljezur.',
    sections: { house: 'Das Haus', casa: 'Casa Indigo', studio: 'Studio Indigo', shop: 'Der Laden', aljezur: 'Aljezur und Umgebung', location: 'Lage', contact: 'Anfragen' },
  ...
  es: {
    nav: { house: 'La Casa', casa: 'Casa Indigo', studio: 'Studio Indigo', shop: 'La Tienda', aljezur: 'Aljezur', location: 'Ubicación', contact: 'Reservar' },
    tagline: 'Una casa de pueblo en Aljezur.',
    sections: { house: 'La Casa', casa: 'Casa Indigo', studio: 'Studio Indigo', shop: 'La Tienda', aljezur: 'Aljezur y alrededores', location: 'Ubicación', contact: 'Reservar' },
